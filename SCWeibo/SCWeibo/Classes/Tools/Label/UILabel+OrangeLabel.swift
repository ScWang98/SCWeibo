...
extension UILabel {
    ...
    private var attributesMap: [String: [NSAttributedString.Key: Any]] {
        get {
            if let attributesMap = objc_getAssociatedObject(self, &AssociatedKeys.AttributesMapName) as? [String: [NSAttributedString.Key: Any]] {
                return attributesMap
            }
            let attributesMap = [String: [NSAttributedString.Key: Any]]()
    ...
    var adjustedFontSize: CGFloat {
        ...
        mutable.setAttributes([NSAttributedString.Key.font: font], range: NSMakeRange(0, mutable.length))
    ...
    var lineRanges: [String] {
        ...
        mutable.setAttributes([NSAttributedString.Key.paragraphStyle: paragraphStyle, NSAttributedString.Key.font: font.withSize(adjustedFontSize)], range: NSMakeRange(0, mutable.length))
    ...
    @discardableResult
    public func setAttributes(_ attributes: [NSAttributedString.Key: Any], type: UILabelLinkType) -> Self {
    ...
    private func createLayoutManager() -> NSLayoutManager? {
        ...
        textStorage.addAttribute(NSAttributedString.Key.paragraphStyle, value: paragraphStyle, range: NSMakeRange(0, textStorage.length))
        textStorage.addAttribute(NSAttributedString.Key.font, value: font.withSize(adjustedFontSize), range: NSMakeRange(0, textStorage.length))
