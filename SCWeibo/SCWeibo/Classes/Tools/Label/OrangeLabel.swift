...
public class OrangeLabel: UILabel {
    ...
    private var scaledLineBackgroundInset: UIEdgeInsets {
        ...
        return UIEdgeInsets(top: lineBackgroundInset.top * scale, left: lineBackgroundInset.left * scale, bottom: lineBackgroundInset.bottom * scale, right: lineBackgroundInset.right * scale)
    }
