...
protocol EmojiCellDelegagte: NSObjectProtocol {
    /// 表情按钮点击
...
class EmojiCell: UICollectionViewCell {
    weak var deleagage: EmojiCellDelegagte?
...
private extension EmojiCell {
    func setupUI() {
        ...
        for i in 0 ... EmojiManager.shared.pageCells {
        ...
        let image = UIImage(named: "compose_emotion_delete_highlighted", in: EmojiManager.shared.bundle, compatibleWith: nil)
